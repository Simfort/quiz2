  ...
  return (
    <main className="w-[476px] items-center max-lg:w-[300px] flex flex-col gap-10">
      <h2 className="text-[24px] text-center mt-[20px] font-bold">
        Enter your email address to receive your personal plan
      </h2>
      <form
        action={saveEmail}
        ...
        <button
          onClick={() => {
            if (validateEmail(email)) {
              redirect("/en/result-screen?" + search);
            }
          }}
        ...
        <p className="text-[12px] text-center">
          We respect your privacy and strive to protect your personal data. Your
          e-mail will be used as a unique identifier of your Kegel plan.
        </p>
      </form>
    </main>
  );
