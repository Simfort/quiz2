...
import { willPlans } from "@/app/lib/plans";

export default function WillPlan() {
  return (
    <section className="flex flex-col gap-6">
      <h3 className="text-[20px] font-bold ">Что ждет вас в вашем плане?</h3>
      ...
      <p className="text-center font-medium mt-[30px] text-[12px]">
        Отказ от ответственности: Если во время занятий спортом у вас участились
        запоры, инфекции мочевыводящих путей, боли в области таза или мочевого
        пузыря, вам следует обратиться за помощью к специалисту!
      </p>
    </section>
  );
}
