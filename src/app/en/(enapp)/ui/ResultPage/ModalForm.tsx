...
export default function ModalForm({
  ...
  return (
    <section className="grid gap-10 w-[1000px] max-lg:flex max-lg:flex-col max-lg:w-[270px]   grid-cols-2">
      <div className="flex-col gap-[50px] flex">
        ...
        <div>
          <div className="flex items-center gap-5 border-b-1 pb-5 border-gray-700">
